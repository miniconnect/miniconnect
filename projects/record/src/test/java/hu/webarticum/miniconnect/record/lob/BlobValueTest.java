...
class BlobValueTest {
    ...
    @Test
    void testEmpty() {
        BlobValue blobValue = BlobValue.of(StoredContentAccess.of(ByteString.empty()));
    ...
    void testFullContent() {
        BlobValue blobValue = BlobValue.of(StoredContentAccess.of(ByteString.of("abcdefghi")));
    ...
    void testContentPart() {
        BlobValue blobValue = BlobValue.of(StoredContentAccess.of(ByteString.of("12345678")));
