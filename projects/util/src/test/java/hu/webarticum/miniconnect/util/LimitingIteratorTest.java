...
class LimitingIteratorTest {
    ...
    void testClearEmpty() {
        ...
        LimitingIterator<Integer> limitingIterator = new LimitingIterator<>(baseIterator, 0L);
    ...
    void testLimitEmpty() {
        Iterator<Integer> baseIterator = Collections.emptyIterator();
        LimitingIterator<Integer> limitingIterator = new LimitingIterator<>(baseIterator, 17L);
        assertThat(iterableOf(limitingIterator)).isEmpty();
    }
    ...
    void testLimitEmptyToNegative() {
        Iterator<Integer> baseIterator = Collections.emptyIterator();
        LimitingIterator<Integer> limitingIterator = new LimitingIterator<>(baseIterator, -8L);
        assertThat(iterableOf(limitingIterator)).isEmpty();
    }
    ...
    void testLimit() {
        ...
        LimitingIterator<Integer> limitingIterator = new LimitingIterator<>(baseIterator, 4L);
    ...
    void testLimitToLargerSize() {
        Iterator<Integer> baseIterator = Arrays.asList(3, 2, 3, 4, 8, 3, 12, -1).iterator();
        LimitingIterator<Integer> limitingIterator = new LimitingIterator<>(baseIterator, 137L);
        assertThat(iterableOf(limitingIterator)).containsExactly(3, 2, 3, 4, 8, 3, 12, -1);
    }
    ...
    void testLimitToNegative() {
        Iterator<Integer> baseIterator = Arrays.asList(3, 2, 3, 4, 8, 3, 12, -1).iterator();
        LimitingIterator<Integer> limitingIterator = new LimitingIterator<>(baseIterator, -5L);
        assertThat(iterableOf(limitingIterator)).isEmpty();
    }
