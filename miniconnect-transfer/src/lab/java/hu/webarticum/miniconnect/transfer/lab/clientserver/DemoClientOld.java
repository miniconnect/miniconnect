...
public class DemoClientOld extends AbstractTransactionalBlockClient<DemoRequest, DemoResponse> {
    
    private final AtomicInteger queryIdCounter = new AtomicInteger(1);
    

    public DemoClientOld(BlockSource source, BlockTarget target) {
        super(source, target);
    }
